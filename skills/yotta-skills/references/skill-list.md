...
| `yotta-memory` | 元忆 | `@yottameta/yotta-memory` | 0.15.0 | 有权限边界的文件式智能体记忆（FACT/PREF/BOUND/COMMIT） |
...
| `yotta-prompt` | 元引 | `@yottameta/yotta-prompt` | 0.2.1 | 意图澄清 + 生态入口（常驻注入，map 串联元阁全家） |
