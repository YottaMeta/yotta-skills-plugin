...
> `skills.json`（登记表为内部台账，不随包分发）。清单更新日期：2026-09-26。

| slug | 中文名 | npm 包 | 清单版本 | 说明 |
|---|---|---|---|---|
| `yotta-anti-shallow` | 元谨 | `@yottameta/yotta-anti-shallow` | 1.4.1 | 防 AI 敷衍规则引擎（深入分析/根因追溯时激活） |
...
| `yotta-memory` | 元忆 | `@yottameta/yotta-memory` | 0.17.3 | 有权限边界的文件式智能体记忆（FACT/PREF/BOUND/COMMIT） |
...
| `yotta-secret` | 元钥 | `@yottameta/yotta-secret` | 0.2.1 | 密钥 / 凭据泄露源头扫描引擎 |
...
| `yotta-prompt` | 元引 | `@yottameta/yotta-prompt` | 0.2.3 | 意图澄清 + 生态入口（常驻注入，map 串联元阁全家） |
