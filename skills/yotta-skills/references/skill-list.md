...
| `yotta-memory` | 元忆 | `@yottameta/yotta-memory` | 0.16.1 | 有权限边界的文件式智能体记忆（FACT/PREF/BOUND/COMMIT） |
...
| `yotta-logwatch` | 元察 | `@yottameta/yotta-logwatch` | 0.2.9 | 安全日志分析检测引擎（攻击链识别/告警聚合） |
